...
export function renderWebTitle({ baseTitle, inboundWebId = null, outboundWebId = null }) {
  const parsed = parseWebTitle(baseTitle);
  const normalizedBaseTitle = parsed.baseTitle.trim();
