...
export const COMPATIBILITY_CONTRACT_REGISTRY_V1 = Object.freeze({
  ...
  checks: Object.freeze([
    ...
    Object.freeze({
      ...
      evidenceKind: "deterministic-repo",
      command: "node --test test/executor-grants.test.mjs test/executor-launch-journal.test.mjs test/executor-launch-coordinator.test.mjs test/executor-app-server-effects.test.mjs test/executor-service-supervisor.test.mjs test/executor-approval-relay.test.mjs test/executor-service-runtime.test.mjs test/executor-startup-recovery.test.mjs test/executor-job-service.test.mjs test/executor-retry-service.test.mjs",
