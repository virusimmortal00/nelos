...
export const COMPATIBILITY_CONTRACT_REGISTRY_V1 = Object.freeze({
  ...
  checks: Object.freeze([
    ...
    Object.freeze({
      ...
      evidenceKind: "deterministic-repo",
      command: "node --test test/model-catalog-freshness.test.mjs test/check-model-catalog.test.mjs test/intelligence-profile-router.test.mjs test/launch-contract.test.mjs",
    ...
    Object.freeze({
      ...
      evidenceKind: "deterministic-repo",
      command: "node --test test/executor-grants.test.mjs test/executor-launch-journal.test.mjs test/executor-launch-coordinator.test.mjs test/executor-app-server-effects.test.mjs test/executor-service-supervisor.test.mjs test/executor-approval-relay.test.mjs test/executor-service-runtime.test.mjs test/executor-startup-recovery.test.mjs test/executor-job-service.test.mjs test/executor-retry-service.test.mjs test/executor-plan-service.test.mjs test/executor-plan-install.test.mjs test/executor-approval-channel.test.mjs test/executor-required-tools.test.mjs",
    ...
    Object.freeze({
      id: "repo.desktop-certification",
      evidenceKind: "deterministic-repo",
      command: "node --test test/desktop-certification-contract.test.mjs test/desktop-certification-cross-repository.test.mjs test/desktop-smoke-contract.test.mjs test/desktop-smoke-scenario-library.test.mjs",
      source: "test/desktop-certification-contract.test.mjs",
    }),
    Object.freeze({
  ...
  capabilities: Object.freeze([
    ...
    Object.freeze({
      ...
      supportedCodexReleases: Object.freeze([]),
      mappings: Object.freeze({
        owned: Object.freeze(["src/executor-contract.mjs", "src/executor-grants.mjs", "src/executor-launch-journal.mjs", "src/executor-launch-coordinator.mjs", "src/executor-app-server-effects.mjs", "src/executor-service-supervisor.mjs", "src/executor-approval-relay.mjs", "src/executor-service-runtime.mjs", "src/executor-result-evidence.mjs", "src/executor-completion-outbox.mjs", "src/executor-job-service.mjs", "src/executor-retry-service.mjs", "src/executor-plan-service.mjs", "src/executor-plan-install.mjs", "src/executor-backend-claim.mjs", "src/executor-approval-channel.mjs", "src/executor-required-tools.mjs", "src/executor-service-channel.mjs", "src/executor-mcp-tools.mjs", "bin/nelos-executor-service", "bin/nelos-verify-owned-executor", "bin/nelos-verify-owned-plan", "bin/nelos-executor-prepare", "bin/nelos-executor-approve"]),
        shared: Object.freeze(["src/execution-store.mjs", "src/task-state.mjs", "src/work-result.mjs", "src/mcp-orchestration.mjs"]),
        test: Object.freeze(["test/executor-grants.test.mjs", "test/executor-launch-journal.test.mjs", "test/executor-launch-coordinator.test.mjs", "test/executor-app-server-effects.test.mjs", "test/executor-service-supervisor.test.mjs", "test/executor-approval-relay.test.mjs", "test/executor-service-runtime.test.mjs", "test/executor-startup-recovery.test.mjs", "test/executor-job-service.test.mjs", "test/executor-retry-service.test.mjs", "test/executor-plan-service.test.mjs", "test/executor-plan-install.test.mjs", "test/executor-approval-channel.test.mjs", "test/executor-required-tools.test.mjs", "test/support/executor-fixture.mjs", "test/support/executor-app-server-fixture.mjs"]),
        documentation: Object.freeze(["docs/executor-admission-and-recovery.md", "docs/executor-approach-audit-2026-09-10.md", "docs/owned-service-canary-2026-09-11.json", "docs/owned-recovery-canary-2026-09-11.json", "docs/owned-retry-canary-2026-09-11.json", "docs/owned-automatic-retry-canary-2026-09-11.json", "docs/owned-completion-inbox-canary-2026-09-11.json", "docs/owned-executor-plan-runbook.md", "docs/owned-full-plan-canary-2026-09-11.json"]),
        upstreamDocumentation: Object.freeze([]),
        upstreamSource: Object.freeze([]),
        generatedSchema: Object.freeze([]),
        runtime: Object.freeze([]),
    ...
    Object.freeze({
      id: "nelos.desktop-certification",
      title: "Provider-neutral certification and retired Desktop harness boundary",
      dependsOn: Object.freeze([]),
      globalInvariant: false,
      supportedCodexReleases: Object.freeze([]),
      mappings: Object.freeze({
        // Retain deleted paths so release diffs still select a boundary check.
        // Mapping a historical path does not ship or execute its former code.
        owned: Object.freeze([
          "src/desktop-certification-contract.mjs",
          "validation/desktop-smoke/**",
          "bin/nelos-capture-screen", "bin/nelos-desktop-gui-driver",
          "bin/nelos-validate-visual-state",
          "scripts/run-dedicated-desktop-lifecycle.mjs",
          "scripts/stage-production-desktop-candidate.mjs",
          "src/archive-projection-convergence.mjs", "src/archive-projection-lane.mjs",
          "src/dedicated-desktop-runtime.mjs", "src/desktop-gui-scenario-driver/**",
          "src/desktop-smoke-cli.mjs", "src/dev-screen-capture.mjs",
          "src/dev-visual-state-validation.mjs", "src/disposable-desktop-smoke.mjs",
          "src/machine-desktop-smoke-adapter.mjs", "src/macos-window-catalog.swift",
        ]),
        shared: Object.freeze(["src/desktop-smoke-contract.mjs"]),
        test: Object.freeze([
          "test/desktop-certification-contract.test.mjs",
          "test/desktop-certification-cross-repository.test.mjs",
          "test/fixtures/desktop-certification/**",
          "test/desktop-smoke-contract.test.mjs", "test/desktop-smoke-scenario-library.test.mjs",
          "test/archive-projection-convergence.test.mjs", "test/archive-projection-lane.test.mjs",
          "test/dedicated-desktop-runtime.test.mjs", "test/desktop-gui-scenario-driver.test.mjs",
          "test/dev-screen-capture.test.mjs", "test/dev-visual-state-validation.test.mjs",
          "test/disposable-desktop-smoke.test.mjs", "test/fixtures/desktop-gui-driver-scenarios.mjs",
          "test/production-desktop-candidate-package.test.mjs",
        ]),
        documentation: Object.freeze([
          "docs/desktop-certification-contract.md",
          "docs/archive-projection-convergence.md", "docs/dedicated-desktop-worker.md",
          "docs/desktop-gui-scenario-driver.md", "docs/developer-screen-capture.md",
          "docs/disposable-desktop-smoke.md", "docs/production-desktop-candidate.md",
        ]),
        upstreamDocumentation: Object.freeze([]),
        upstreamSource: Object.freeze([]),
        generatedSchema: Object.freeze([]),
        runtime: Object.freeze([]),
        checks: Object.freeze(["repo.desktop-certification"]),
      }),
    }),
    Object.freeze({
      ...
      mappings: Object.freeze({
        owned: Object.freeze([
          ...
          "src/intelligence-profile-catalog.mjs",
          "src/intelligence-profile-router.mjs",
          "src/launch-contract.mjs",
          ...
          "skills/manage-nelos-tasks/agents/openai.yaml",
        ]),
        shared: Object.freeze([
          ".codex-plugin/plugin.json",
          "distribution-provenance.json",
        ...
        test: Object.freeze([
          ...
          "test/skill-discovery-metadata.test.mjs",
          ...
          "test/mcp-result-collection.test.mjs",
