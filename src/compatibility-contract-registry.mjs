...
export const COMPATIBILITY_CONTRACT_REGISTRY_V1 = Object.freeze({
  ...
  capabilities: Object.freeze([
    ...
    Object.freeze({
      ...
      supportedCodexReleases: Object.freeze([]),
      mappings: Object.freeze({
        owned: Object.freeze(["src/executor-contract.mjs", "src/executor-grants.mjs", "src/executor-launch-journal.mjs", "src/executor-launch-coordinator.mjs", "src/executor-app-server-effects.mjs", "src/executor-service-supervisor.mjs", "src/executor-approval-relay.mjs", "src/executor-service-runtime.mjs", "src/executor-result-evidence.mjs", "src/executor-job-service.mjs", "src/executor-retry-service.mjs", "src/executor-service-channel.mjs", "src/executor-mcp-tools.mjs", "bin/nelos-executor-service", "bin/nelos-verify-owned-executor"]),
        ...
        documentation: Object.freeze(["docs/executor-admission-and-recovery.md", "docs/executor-approach-audit-2026-09-10.md", "docs/owned-service-canary-2026-09-11.json", "docs/owned-recovery-canary-2026-09-11.json", "docs/owned-retry-canary-2026-09-11.json", "docs/owned-automatic-retry-canary-2026-09-11.json"]),
        upstreamDocumentation: Object.freeze([]),
        upstreamSource: Object.freeze([]),
        generatedSchema: Object.freeze([]),
        runtime: Object.freeze([]),
