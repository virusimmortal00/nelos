    ...
    Object.freeze({
      ...
      mappings: Object.freeze({
        owned: Object.freeze([
          ...
          "src/runtime-compatibility.mjs",
          "src/runtime-compatibility.json",
          "src/runtime-retention.mjs",
        ...
        test: Object.freeze([
          ...
          "test/observation-scope.test.mjs",
          "test/unresolved-spinoffs.test.mjs",
          "test/support/unresolved-spinoffs.mjs",
          "test/fixtures/unresolved-spinoffs.json",
          ...
          "test/runtime-upgrade-continuity.test.mjs",
          "test/support/runtime-distribution.mjs",
