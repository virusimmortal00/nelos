...
function isCompatibilitySensitive(path) {
  ...
  return /^(?:src|bin|scripts|test|docs|validation)\//u.test(path) ||
    [
      "package.json",
      "package-lock.json",
...
export const COMPATIBILITY_CONTRACT_REGISTRY_V1 = Object.freeze({
  ...
  checks: Object.freeze([
    ...
    Object.freeze({
      ...
      evidenceKind: "deterministic-repo",
      command: "node --test test/experimentation-contract-kernel.test.mjs test/experimentation-contract-experiment.test.mjs test/corpus-release-contract.test.mjs test/experimentation-task-contract.test.mjs test/experimentation-runtime-lock-contract.test.mjs test/experimentation-contract-export.test.mjs test/experimentation-contract-semver.test.mjs test/experimentation-corpus.test.mjs test/experimentation-evidence.test.mjs test/headless-experiment-runtime.test.mjs test/dedicated-desktop-runtime.test.mjs test/experiment-runner.test.mjs test/remote-desktop-runner.test.mjs test/experiment-ci-gates.test.mjs test/experiment-fleet.test.mjs test/experimentation-reporting.test.mjs test/signed-in-pilot.test.mjs test/api-baseline-harness.test.mjs",
      source: "test/experimentation-contract-export.test.mjs",
    }),
    Object.freeze({
      id: "repo.desktop-production-contracts",
      evidenceKind: "deterministic-repo",
      command: "npm run check:desktop-runner",
      source: "test/proxmox-production-admission.test.mjs",
    }),
    Object.freeze({
  ...
  capabilities: Object.freeze([
    ...
    Object.freeze({
      ...
      mappings: Object.freeze({
        owned: Object.freeze([
          ...
          "bin/nelos-validate-archive-convergence",
          ...
          "src/archive-projection-convergence.mjs",
          "src/archive-projection-lane.mjs",
          ...
          "src/desktop-gui-scenario-driver/**",
          "src/remote-desktop-contract/**",
          "src/remote-desktop-evidence/**",
          "src/remote-desktop-runner/**",
        ...
        test: Object.freeze([
          ...
          "test/archive-projection-convergence.test.mjs",
          "test/archive-projection-lane.test.mjs",
          ...
          "test/fixtures/desktop-gui-driver-scenarios.mjs",
          "test/fixtures/remote-desktop-contract-v1.mjs",
        ]),
        documentation: Object.freeze([
          "README.md",
          ...
          "docs/desktop-gui-scenario-driver.md",
          "docs/remote-desktop-validation-contract.md",
          "docs/remote-desktop-runner-operations.md",
    ...
    Object.freeze({
      id: "nelos.desktop-production",
      title: "Identity-bound Desktop production validation",
      dependsOn: Object.freeze(["app-server.strict-bridge"]),
      globalInvariant: false,
      supportedCodexReleases: Object.freeze([]),
      mappings: Object.freeze({
        owned: Object.freeze([
          ".github/workflows/proxmox-template.yml",
          "bin/nelos-capture-screen",
          "bin/nelos-desktop-gui-driver",
          "bin/nelos-desktop-runner",
          "bin/nelos-golden-builder-runner",
          "bin/nelos-golden-host-installer",
          "bin/nelos-volume-attestor-host-installer",
          "bin/nelos-observe-current-lease",
          "bin/nelos-prepare-production-guest-task",
          ...
          "src/macos-window-catalog.swift",
          "src/production-archive-surface-observer.mjs",
          "src/production-guest-task.mjs",
          "src/production-task-preparation.mjs",
          "src/production-task-surface-observer.mjs",
          "src/protected-capture-proof.mjs",
          "src/proxmox-desktop-runtime.mjs",
          "src/proxmox-lease-authority.mjs",
          "src/proxmox-ssh-transport.mjs",
          "src/remote-desktop-contract/**",
          "src/remote-desktop-evidence/**",
          "src/remote-desktop-runner/**",
          "validation/proxmox-desktop/**",
          "validation/proxmox/desktop/**",
        ]),
        shared: Object.freeze([
          "package-lock.json",
        ...
        test: Object.freeze([
          ...
          "test/fixtures/atspi-archive-surface-probe.py",
          "test/fixtures/atspi-descendant-surface-probe.py",
          "test/fixtures/atspi-imagemagick-cache-probe.py",
          ...
          "test/remote-desktop-evidence.test.mjs",
          "test/remote-desktop-runner.test.mjs",
          "test/support/fake-production-task-app-server.mjs",
        ...
        documentation: Object.freeze([
          ...
          "docs/proxmox-desktop-host-run-binding.md",
          "docs/proxmox-desktop-lease-authority.md",
          "docs/proxmox-linux-desktop.md",
          "docs/remote-desktop-runner-operations.md",
        ...
        generatedSchema: Object.freeze([]),
        runtime: Object.freeze([]),
        checks: Object.freeze(["repo.desktop-production-contracts"]),
      }),
    }),
    Object.freeze({
