...
export const COMPATIBILITY_CONTRACT_REGISTRY_V1 = Object.freeze({
  ...
  checks: Object.freeze([
    ...
    Object.freeze({
      ...
      evidenceKind: "deterministic-repo",
      command: "node --test test/experimentation-contract-kernel.test.mjs test/experimentation-contract-experiment.test.mjs test/corpus-release-contract.test.mjs test/experimentation-task-contract.test.mjs test/experimentation-runtime-lock-contract.test.mjs test/experimentation-contract-export.test.mjs test/experimentation-contract-semver.test.mjs test/experimentation-corpus.test.mjs test/experimentation-evidence.test.mjs test/headless-experiment-runtime.test.mjs test/dedicated-desktop-runtime.test.mjs test/experiment-runner.test.mjs test/experiment-ci-gates.test.mjs test/experiment-fleet.test.mjs test/experimentation-reporting.test.mjs test/signed-in-pilot.test.mjs test/api-baseline-harness.test.mjs",
    ...
    Object.freeze({
      ...
      mappings: Object.freeze({
        owned: Object.freeze([
          ...
          "bin/nelos-proxmox-desktop-test-driver",
          ...
          "src/next-action.mjs",
          "src/mcp-server.mjs",
          "src/machine-desktop-smoke-adapter.mjs",
          ...
          "src/proxmox-desktop-test-driver.mjs",
          "src/proxmox-review-output.mjs",
          ...
          "scripts/run-desktop-smoke-certification.mjs",
          "scripts/run-desktop-smoke-routine.mjs",
        ...
        test: Object.freeze([
          ...
          "test/desktop-bundle-review.test.mjs",
          "test/desktop-gui-scenario-driver.test.mjs",
          "test/desktop-smoke-contract.test.mjs",
          "test/desktop-smoke-evidence-contract.test.mjs",
          "test/desktop-smoke-entrypoints.test.mjs",
          ...
          "test/fresh-vm-desktop-runner.test.mjs",
          ...
          "test/proxmox-desktop-test-driver.test.mjs",
