...
The `0.4.0` release gate revalidated isolated npm distributions of
`codex-cli 0.144.5` and `0.144.6` on 2026-07-28. Their generated initialization,
read, name, resume, bounded turn-list, start, steer, archive, status, and
active-flag shapes were identical. Both exact binaries also completed the
two-turn live App Server verifier with confirmed archival and cleanup.
