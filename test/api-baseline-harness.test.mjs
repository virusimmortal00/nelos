...
test("npm/plugin payload excludes calibration and keeps the 0.12.15 release invariant", async () => {
  ...
  assert.equal(packageMetadata.version, "0.12.15");
  assert.equal(plugin.version, "0.12.15");
  assert.equal(plugin.releaseBuildIdentity, "nelos-release-v1:0.12.15");
  assert.equal(mcp.mcpServers.nelos.env.NELOS_PLUGIN_VERSION, "0.12.15");
  assert.equal(mcp.mcpServers.nelos.env.NELOS_RELEASE_BUILD_IDENTITY, "nelos-release-v1:0.12.15");
