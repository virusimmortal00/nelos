...
test("npm/plugin payload excludes calibration and keeps release identities coherent", async () => {
  ...
  assert.equal(mcp.mcpServers.nelos.env.NELOS_RELEASE_BUILD_IDENTITY, plugin.releaseBuildIdentity);
