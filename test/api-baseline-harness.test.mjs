...
test("npm/plugin payload excludes calibration and keeps the 0.12.10 release invariant", async () => {
  ...
  assert.equal(packageMetadata.version, "0.12.10");
  assert.equal(plugin.version, "0.12.10");
  assert.equal(plugin.releaseBuildIdentity, "nelos-release-v1:0.12.10");
  assert.equal(mcp.mcpServers.nelos.env.NELOS_PLUGIN_VERSION, "0.12.10");
