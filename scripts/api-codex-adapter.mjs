...
import { claimApiOperation, safeApiRuntimeError } from "../src/api-baseline-runtime.mjs";
...
try {
  ...
  const response = await executeApiBaselineAttempt({ request, claimOperation: (value) => claimApiOperation(value, { ledgerRoot }) });
